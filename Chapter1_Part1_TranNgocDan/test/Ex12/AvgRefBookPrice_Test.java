 ...
 * @author snow
 */
public class AvgRefBookPrice_Test {
    
    public AvgRefBookPrice_Test() {
    }
    ...
    //
     @Test
     public void avgRefBookPrice_Test1(){
         ...
         cl.addRefBook(rf2);
         double ex = 472500;
         double ac = cl.avgRefBookPrice();
         assertEquals(ex, ac, 0.001);
     }
     
     @Test
     public void avgRefBookPrice_Test2(){
         BookCollection cl = new BookCollection();
         double ex = 0;
         double ac = cl.avgRefBookPrice();
         assertEquals(ex, ac, 0.001);
